      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {topStudents.map((student) => {
          ...
          return (
            ...
            >
              {/* Rank Badge */}
              <div className={`absolute top-4 left-4 w-8 h-8 bg-gradient-to-br ${student.color} rounded-full flex items-center justify-center`}>
                <span className="text-white font-bold text-sm">#{student.rank}</span>
              </div>

              {/* Background Pattern */}
              <div className={`absolute top-0 right-0 w-20 h-20 ${student.bgColor} rounded-bl-full opacity-50`} />
              ...
              <div className="p-6 pt-8">
                ...
                <p className="text-sm text-gray-600 mb-4">{student.specialty}</p>

                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-gray-600">المتوسط العام</span>
                    <span className="text-lg font-bold text-gray-900">{student.average}</span>
                  </div>
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-sm font-semibold text-blue-600">{student.projects}</span>
                  </div>
                </div>
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {achievements.map((achievement, index) => {
              ...
              return (
                <div key={index} className="flex items-center space-x-reverse space-x-3 p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg border border-blue-100">
                  ...
                  <div className="flex-1 min-w-0">
                    <h4 className="text-sm font-semibold text-gray-900">{achievement.student}</h4>
